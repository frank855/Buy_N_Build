...
FlowRouter.route('/showcase',{
  name: 'showcase',
  action(){
    BlazeLayout.render('MainLayout', {main:'Casetest'});
  }
});

FlowRouter.route('/showtvideo',{
  name: 'showtvideo',
  action(){
    BlazeLayout.render('MainLayout', {main:'Tvideotest'});
  }
});

FlowRouter.route('/showram',{
  name: 'showram',
  action(){
    BlazeLayout.render('MainLayout', {main:'Ramtest'});
  }
});
// Autoforms
